...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    CTL_GRV, KC_LALT, KC_LGUI,                                                                              KC_RGUI, KC_RALT, KC_RCTL,
                                                 LWR_DEL, KC_SPC,       KC_ENT,  RSE_HOM,
                                                 KC_BSPC, KC_SPC,       KC_ENT,  KC_END
  ),
  ...
  [_RAISE] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, _______,      _______, _______, _______, KC_UP,   _______, _______, KC_F12,
    _______, _______, KC_LEFT, KC_RGHT, KC_UP,   _______,                        _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
    _______, KC_UP,   _______, _______, KC_DOWN, _______, _______,      _______, _______, _______, _______, _______, _______, _______,
